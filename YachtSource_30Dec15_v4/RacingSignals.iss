...
#define result Exec('cmd /c xcopy/s/y/q', '"e:\My Documents\Ais\YachtSource" "e:\My Documents\Ais\YachtSourceBackup\YachtSource_' + MyAppVersion + '\"')
...
;outputdir=C:\website\
outputdir="C:\DirectNic\Live Parent (ArundaleCom)\docs\ais\"
...
;Name: "{userappdata}\Arundale\RacingSignals" ;dont think we need this for RacingSignals as its in the CommonAppData
[Files]
; begin VB system files
;dll'S CANNOT BE IN SYSTEM DIRECTORY
Source: "vbfiles\Support\msvbvm60.dll"; DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
Source: "vbfiles\Support\oleaut32.dll"; DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
Source: "vbfiles\Support\olepro32.dll"; DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
Source: "vbfiles\Support\asycfilt.dll"; DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile
Source: "vbfiles\Support\stdole2.tlb";  DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regtypelib
Source: "vbfiles\Support\comcat.dll";   DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
...
Source: "vbfiles\Support\msstdfmt.dll";   DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
...
Source: "vbfiles\Support\capicom.dll";   DestDir: "{sys}"; OnlyBelowVersion: 0,6; Flags: restartreplace uninsneveruninstall sharedfile regserver
...
Source: "C:\WINDOWS\system32\MSHFlxGd.ocx"; DestDir: "{sys}"; Flags: restartreplace sharedfile regserver
Source: "C:\WINDOWS\system32\MSINET.ocx"; DestDir: "{sys}"; Flags: restartreplace sharedfile regserver
;Windows 8
